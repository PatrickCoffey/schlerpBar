...
case $1 in
    wifi*)
        ...
        dl_speed=${data_arr[0]}
        ul_speed=${data_arr[1]}
        title="<span font='${font_icon_notify} 42'>${icon_wifi_con}</span><span font='${font_notify} 42'> wifi</span>"
        body="
<span font='${font_icon_notify} 36'>${icon_dl}</span><span font='${font_notify} 32'>: ${dl_speed}</span>
<span font='${font_icon_notify} 36'>${icon_ul}</span><span font='${font_notify} 32'>: ${ul_speed}</span>"
    ...
    disk*)
        ...
        body="
<span font='${font_icon_notify} 36'>${icon_hd}</span><span font='${font_notify} 32'>: ${root_perc}%</span>
<span font='${font_icon_notify} 36'>${icon_home}</span><span font='${font_notify} 32'>: ${home_perc}%</span>"
    ...
    mem*)
        ...
        body="
<span font='${font_notify} 32'>ram: ${mem} of ${mem_max}</span>
<span font='${font_notify} 32'>swap: ${swap} of ${swap_max}</span>"
    ...
    task*)
        ...
        body="
<span font='${font_notify} 32'><u>top cpu</u></span>
...
<span font='${font_notify} 32'>${top_mem_3_pid} | ${top_mem_3_name} | ${top_mem_3_mem}</span>"
    ...
    cpu*)
        ...
        body="
<span font='${font_notify} 32'>cpu total: ${cpu_tot}%</span>
